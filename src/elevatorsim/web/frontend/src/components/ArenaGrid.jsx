  ...
  if (!contestants.length) {
    return (
      <div className="panel p-10 text-center text-[var(--ink-3)]">
        ...
        <div className="font-display font-bold text-[var(--ink-2)]">Build a matchup to start the race</div>
        <div className="text-sm mt-1">Pick contestants and a traffic regime above, then hit <b>Race!</b></div>
      </div>
    );
  }
  return (
