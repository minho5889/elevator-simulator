...
export const STRINGS = {
  en: {
    ...
    'kid.score.wait': 'Waiting time',
    'kid.score.waitHint': 'shorter is better',
    'kid.score.delivered': 'People delivered',
    'kid.score.deliveredHint': 'more is better',
    'kid.winner': '{name} wins!',
    'kid.tie': "It's a tie!",
    'kid.play': 'Play',
    'kid.pause': 'Pause',
    'kid.watchAgain': 'Watch again',
    'kid.pickAnother': 'Pick another day',
    'kid.robot.name': 'Robot',
    'kid.robot.blurb': 'Zippy! Follows one simple rule.',
    'kid.brainy.name': 'Brainy',
    'kid.brainy.blurb': 'Careful! Plans ahead.',
    'day.morning_rush.name': 'Morning Rush',
    'day.morning_rush.desc': 'Everyone arrives and rides up!',
    'day.lunchtime.name': 'Lunchtime',
    'day.lunchtime.desc': 'Up and down — lunch crowds!',
    'day.quiet_day.name': 'Quiet Day',
    'day.quiet_day.desc': 'Just a few people, going all over.',
  },
  ...
  ko: {
    ...
    'kid.loading': '불러오는 중…',
    'kid.score.wait': '기다린 시간',
    'kid.score.waitHint': '짧을수록 좋아요',
    'kid.score.delivered': '데려다준 사람',
    'kid.score.deliveredHint': '많을수록 좋아요',
    'kid.winner': '{name} 승리!',
    'kid.tie': '비겼어요!',
    'kid.play': '재생',
    'kid.pause': '멈춤',
    'kid.watchAgain': '다시 보기',
    'kid.pickAnother': '다른 날 고르기',
    'kid.robot.name': '로봇',
    'kid.robot.blurb': '빠릿빠릿! 간단한 규칙 하나만 따라요.',
    'kid.brainy.name': '브레이니',
    'kid.brainy.blurb': '신중하게! 미리 계획해요.',
    'day.morning_rush.name': '아침 러시',
    'day.morning_rush.desc': '모두 도착해서 위로 올라가요!',
    'day.lunchtime.name': '점심시간',
    'day.lunchtime.desc': '위로 아래로 — 점심 인파!',
    'day.quiet_day.name': '한가한 날',
    'day.quiet_day.desc': '몇 명만, 여기저기로.',
  },
};
